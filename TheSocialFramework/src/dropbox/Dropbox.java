...
/**
 * Identification pour accéder à l'application de la Dropbox
 * @throws IOException
 * @throws DbxException
 */
	
	public void identification(String APP_KEY, String APP_SECRET) throws IOException, DbxException {
		...
		try {
			...
			try {
				DbxEntry.File uploadedFile = client.uploadFile(
						"/magnum-opus.txt", DbxWriteMode.add(),
